...
const targetCollection = "reservations";

const manageReservationsCollection = async () => {
  ...
  try {
    ...
    // Check if the reservations collection already exists
    const reservationsCollectionExists = await db
