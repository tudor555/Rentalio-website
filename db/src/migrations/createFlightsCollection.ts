...
const targetCollection = "flights";

const manageFlightsCollection = async () => {
  ...
  try {
    ...
    // Check if the flights collection already exists
    const flightsCollectionExists = await db
