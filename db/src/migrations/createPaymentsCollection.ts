...
const targetCollection = "payments";

const managePaymentsCollection = async () => {
  ...
  try {
    ...
    // Check if the payments collection already exists
    const paymentsCollectionExists = await db
